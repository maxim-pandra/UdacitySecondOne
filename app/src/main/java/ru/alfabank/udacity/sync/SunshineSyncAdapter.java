package ru.alfabank.udacity.sync;
...
import ru.alfabank.udacity.BuildConfig;
import ru.alfabank.udacity.MainActivity;
import ru.alfabank.udacity.R;
import ru.alfabank.udacity.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor query = getContext().getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI, new String[]{WeatherContract.LocationEntry._ID}, selection, selectionArgs, null);
        if (query != null && query.moveToFirst()) {
            int locationIndex = query.getColumnIndex(WeatherContract.LocationEntry._ID);
            locationId = query.getLong(locationIndex);
            query.close();
        } else {
            ...
            Uri insert = getContext().getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, contentValues);
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    android.support.v7.app.NotificationCompat.Builder nBuilder = new android.support.v7.app.NotificationCompat.Builder(getContext());
